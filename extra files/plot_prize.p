...
set ylabel "Prize Collected" font ",14"
set xlabel "Budget (miles)" font ",14"
set title "(a) Total Prize." offset 0,-1 font ",14"
...
# Plot the data, applying the colors and fill styles directly here
plot 'prize_data.txt' using 2:xtic(1) title 'Greedy 1' lc rgb "black" fs pattern 0 border rgb "black", \
